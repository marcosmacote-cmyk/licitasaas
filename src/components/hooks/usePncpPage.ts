...
export function usePncpPage({ companies, onRefresh, items = [], initialContext, onContextConsumed }: UsePncpPageParams) {
    ...
    return {
        ...
        // Favorites Filters
        favSearch: favorites.favSearch, setFavSearch: favorites.setFavSearch,
        favDateFilter: favorites.favDateFilter, setFavDateFilter: favorites.setFavDateFilter,
        favDateStart: favorites.favDateStart, setFavDateStart: favorites.setFavDateStart,
        favDateEnd: favorites.favDateEnd, setFavDateEnd: favorites.setFavDateEnd,
        favModality: favorites.favModality, setFavModality: favorites.setFavModality,
        favUf: favorites.favUf, setFavUf: favorites.setFavUf,
        favValMin: favorites.favValMin, setFavValMin: favorites.setFavValMin,
        favValMax: favorites.favValMax, setFavValMax: favorites.setFavValMax,
        favSortBy: favorites.favSortBy, setFavSortBy: favorites.setFavSortBy,
        favValidity: favorites.favValidity, setFavValidity: favorites.setFavValidity,
        showFavFilters: favorites.showFavFilters, setShowFavFilters: favorites.setShowFavFilters,
        pdfColumns: favorites.pdfColumns, setPdfColumns: favorites.setPdfColumns,
        availableModalities: favorites.availableModalities,
        availableUfs: favorites.availableUfs,
        clearFavFilters: favorites.clearFavFilters,
