...
class PncpSearchService {
    ...
    static async searchLocal(input) {
        ...
        if (orgaoNames.length > 100) {
            ...
            logger_1.logger.warn(`[PncpSearch] orgaosLista truncated to 100 items to prevent event loop exhaustion.`);
        }
        ...
        if (keywords && keywords.trim()) {
            ...
            if (rawTerms.length > 20) {
                ...
                logger_1.logger.warn(`[PncpSearch] keywords truncated to 20 items.`);
            }
