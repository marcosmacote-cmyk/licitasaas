...
16. OBJETO E CRITÉRIO:
    ...
    f) Para "link_sistema": Extraia a URL oficial do portal expressa no edital, se houver (ex: "www.novobbmnet.com.br", "www.bll.org.br", "bnc.org.br", "licitamaisbrasil.com.br"). ⚠️ REGRA ESPECIAL COMPRASNET: Se o portal for "Compras.gov.br" e o edital exibir o código "UASG" ou "Código da Unidade Compradora" (ex: 943001), mas NÃO trouxer uma URL expressa, você DEVE injetar em "link_sistema" a marcação: "COMPRASNET:UASG:NUMERO" (ex: "COMPRASNET:UASG:943001"). O sistema converterá automaticamente este marcador na URL correta de monitoramento. Se não houver link nem UASG, deixe vazio.
