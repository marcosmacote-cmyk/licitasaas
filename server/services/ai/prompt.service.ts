...
16. OBJETO E CRITÉRIO:
    ...
    f) Para "link_sistema": Extraia a URL oficial do portal de disputa eletrônica expressa no edital, se houver (ex: "www.novobbmnet.com.br", "www.bll.org.br", "bnc.org.br", "licitamaisbrasil.com.br"). IMPORTANTE: Se o portal for "Compras.gov.br" ou "ComprasNet", NÃO tente construir nenhuma URL — deixe "link_sistema" VAZIO. O sistema já possui mecanismos automáticos para identificar e vincular processos ComprasNet. Apenas extraia links de OUTROS portais expressos no edital.
