                        ...
                        <div className="pe-modal" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="pe-header">
                                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                                    ...
                                    <div>
                                        <div style={{ fontSize: '0.92rem', fontWeight: 800, color: '#111827', lineHeight: 1.15 }}>
                                            {stage}
                                        </div>
                                        <div style={{ fontSize: '0.6rem', fontWeight: 600, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.06em', marginTop: 1 }}>
                                            Entenda esta fase
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="pe-body">
                                ...
                                <div className="pe-modules-grid">
                                    {/* Disponíveis */}
                                    <div className="pe-module-block" style={{ borderColor: '#d1fae5', background: '#f6fef9' }}>
                                        <span className="pe-label" style={{ color: '#15803d' }}>Disponíveis</span>
                                    ...
                                    {/* Bloqueados */}
                                    <div className="pe-module-block" style={{ borderColor: '#fee2e2', background: '#fff8f8' }}>
                                        <span className="pe-label" style={{ color: '#b91c1c' }}>Bloqueados</span>
                                        <div className="pe-badge-list">
