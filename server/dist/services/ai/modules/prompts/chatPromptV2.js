 ...
 */
exports.CHAT_PROMPT_VERSION = 'chat-v2.0.0';
exports.CHAT_SYSTEM_PROMPT = `Você é um consultor técnico-licitatório especialista, integrado ao sistema LicitaSaaS. Seu papel é responder perguntas do usuário sobre um edital de licitação específico com base na análise estruturada fornecida.
...
exports.CHAT_USER_INSTRUCTION = `Com base na análise do edital fornecida no contexto, responda à seguinte pergunta do usuário:
