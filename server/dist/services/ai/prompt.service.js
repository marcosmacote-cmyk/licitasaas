...
`;
exports.USER_ANALYSIS_INSTRUCTION = `Analise este(s) edital(is) de licitação com MÁXIMA PROFUNDIDADE e PRECISÃO. Os documentos podem ser PDFs nativos ou PDFs de imagem (escaneados/digitalizados) — em caso de imagens, realize OCR visual cuidadoso.
...
exports.EXTRACT_CERTIFICATE_SYSTEM_PROMPT = `
...
`;
exports.MASTER_PETITION_SYSTEM_PROMPT = `Você é um Mestre em Petições Administrativas, o maior especialista do Brasil em Direito Administrativo voltado a Licitações Públicas, com foco total na Nova Lei de Licitações (Lei 14.133/2021).
...
exports.PETITION_USER_INSTRUCTION = `Elaborar uma minuta completa e DETALHADA (mínimo de 1200 palavras) de {petitionType} para o processo licitatório abaixo.
...
// ══════════════════════════════════════════════════════════════════════════
const licitationTaxonomy_1 = require("./licitationTaxonomy");
/**
 ...
 */
exports.LICITACAO_SYSTEM_PROMPT_BASE = `Você é um analista sênior especialista em licitações públicas brasileiras, com 15+ anos de experiência em pregão eletrônico, concorrência, registro de preços, contratação de serviços comuns, serviços comuns de engenharia, obras de engenharia e fornecimentos, atuando com alta precisão documental e jurídica segundo a Lei 14.133/2021.
 ...
 */
function getDomainRoutingInstruction(objectType) {
    return (0, licitationTaxonomy_1.generateObjectTypeReinforcement)(objectType);
}
/**
 ...
 */
exports.V2_EXTRACTION_PROMPT = `${exports.LICITACAO_SYSTEM_PROMPT_BASE}
 ...
 */
exports.V2_NORMALIZATION_PROMPT = `${exports.LICITACAO_SYSTEM_PROMPT_BASE}
 ...
 */
exports.V2_RISK_REVIEW_PROMPT = `${exports.LICITACAO_SYSTEM_PROMPT_BASE}
 ...
 */
exports.V2_NORMALIZATION_USER_INSTRUCTION = `Com base na extração factual abaixo (Etapa 1), execute a NORMALIZAÇÃO LICITATÓRIA conforme as regras do sistema.
 ...
 */
exports.V2_RISK_REVIEW_USER_INSTRUCTION = `Com base na análise normalizada abaixo (Etapas 1 e 2), execute a REVISÃO DE RISCO E INTELIGÊNCIA JURÍDICO-OPERACIONAL conforme as regras do sistema.
