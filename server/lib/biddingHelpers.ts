...
export const MONITORABLE_DOMAINS = [
 ...
 */
export function hasMonitorableDomain(link: string): boolean {
 ...
 */
export function detectPlatformFromLink(link: string): string | null {
    const l = link.toLowerCase();
 ...
 */
export function normalizeModality(raw: string | undefined | null): string {
 ...
 */
export function normalizePortal(portal: string, link?: string | null): string {
