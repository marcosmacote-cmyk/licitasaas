...
// ═══════════════════════════════════════════════════════════════
function buildRepairPrompt(text, issues, facts) {
 ...
 */
async function repairDeclaration(originalText, originalTitle, issues, facts, validateFn, aiCallFn) {
    const noRepair = {
        attempted: false,
        improved: false,
        text: originalText,
 ...
 */
function createGeminiRepairFn(models, callFn, modelName = 'gemini-2.5-flash', trackingOptions) {
    return async (prompt) => {
