...
const BASE_GOVERNANCE: Record<KanbanStage, Omit<StageGovernance, 'stage'>> = {
    ...
    'Pós-Sessão': {
        ...
        allowedModules: ['production-dossier', 'companies', 'production-declaration'],
        blockedModules: ['monitoring', 'production-proposal'],
    ...
    'Recurso': {
        ...
        allowedModules: ['production-petition', 'companies', 'intelligence'],
        blockedModules: ['production-proposal', 'monitoring'],
