...
16. OBJETO E CRITÉRIO:
    ...
    f) Para "link_sistema": Extraia a URL oficial do portal expressa no edital, se houver. ⚠️ REGRA ESPECIAL COMPRASNET: Se o edital/termo informar que a licitação opera no "Compras.gov.br" ou afins, e exibir graficamente o número "UASG" ou "Código da Unidade Compradora" (ex: 943001), mas não trouxer link expresso, você DEVE construir obrigatoriamente o link oficial de acompanhamento e injetá-lo em "link_sistema": "https://cnetmobile.estaleiro.serpro.gov.br/comprasnet-web/public/compras/acompanhamento-compra?coUasg=[NUMERO_UASG]". Em outros portais (BLL, BNC, etc.), extraia a URL expressa do edital. Se não houver link nem UASG, deixe vazio.
