 ...
 */
export const ORACLE_PROMPT_VERSION = 'oracle-v2.1.0';

export const ORACLE_SYSTEM_PROMPT = `Você é um comparador técnico especialista em verificar aderência MATERIAL entre exigências de editais de licitação e documentos técnicos da empresa (atestados, CATs, certificados, contratos).
...
export const ORACLE_USER_INSTRUCTION = `Compare as exigências técnicas do edital com os documentos da empresa.
