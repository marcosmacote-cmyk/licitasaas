        ...
        <div className="page-container">
            ...
            {b.hasActiveFilters && (
                <div className="flex-center flex-wrap gap-1 mb-3">
                    ...
                    {b.filters.specialFilter === 'upcoming_sessions' && <FilterChip label="📅 Próximas Sessões (15 dias)" color="var(--color-primary)" onRemove={() => b.setFilters({ ...b.filters, specialFilter: undefined })} />}
                    {b.filters.specialFilter === 'today_reminders' && <FilterChip label="🔔 Lembretes de Hoje" color="var(--color-urgency)" onRemove={() => b.setFilters({ ...b.filters, specialFilter: undefined })} />}
