 ...
 */
export const DOSSIER_PROMPT_VERSION = 'dossier-v2.0.0';

export const DOSSIER_SYSTEM_PROMPT = `Você é um organizador de documentação licitatória, especializado em converter análises de editais em checklists documentais operacionais para equipes de licitações.
...
export const DOSSIER_USER_INSTRUCTION = `Com base na análise do edital, gere o checklist documental completo.
