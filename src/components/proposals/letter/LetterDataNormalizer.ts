...
export class LetterDataNormalizer {
    ...
    private normalizeCommercial(
        ...
        return {
            ...
            paymentConditions: contractConditions?.condicoes_pagamento || undefined,
    ...
    private normalizeExecution(contractConditions: any): ProposalLetterData['execution'] {
        return {
            executionLocation: contractConditions?.local_execucao || undefined,
            executionDeadline: contractConditions?.prazo_execucao || contractConditions?.prazo_entrega || undefined,
            contractDuration: contractConditions?.vigencia_contrato || undefined,
        };
    }
