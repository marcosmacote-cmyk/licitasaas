...
import { DollarSign, AlertTriangle, Calendar, BadgeCheck, Building2, FileSearch2, ScanSearch, FileCheck, CheckCircle2, FileX, Loader2, ShieldAlert, BarChart3 } from 'lucide-react';
import type { useAiReport } from '../hooks/useAiReport';
            ...
            <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 'var(--space-2) var(--space-6)' }}>
                    {([ 
                        ...
                        { label: 'Portal', value: report.processMetadata.portal },
                        ...
                        <div className="report-card">
                            ...
                            {report.isLoadingDocs ? (
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' }}>
                                    {Object.entries(report.categorizedDocs).map(([category, docs]: [string, any]) => (
                                        <div key={category}>
