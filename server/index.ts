...
app.get('/api/team', authenticateToken, requireAdmin, async (req: any, res) => {
    try {
        const users = await prisma.user.findMany({
...
app.post('/api/team', authenticateToken, requireAdmin, async (req: any, res) => {
    try {
...
app.put('/api/team/:id', authenticateToken, requireAdmin, async (req: any, res) => {
    try {
        const { id } = req.params;
...
app.put('/api/team/:id/reset', authenticateToken, requireAdmin, async (req: any, res) => {
    try {
        const { id } = req.params;
